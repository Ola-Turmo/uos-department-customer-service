...
const DEFAULT_LIMITATION_MESSAGES: Record<string, string> = {
  zendesk: "Zendesk integration is currently unavailable. Triage and escalation workflows may be delayed.",
  intercom: "Intercom integration is currently unavailable. Chat-based issue handling may be limited.",
  gmail: "Gmail integration is currently unavailable. Email-based issue handling may be delayed.",
  shopify: "Shopify integration is currently unavailable. Order-related issue context may be limited.",
  stripe: "Stripe integration is currently unavailable. Billing issue triage may be limited.",
  whatsapp: "WhatsApp integration is currently unavailable. WhatsApp-based support may be delayed.",
  googledrive: "Google Drive integration is currently unavailable. Knowledge article access may be limited.",
...
function getAffectedWorkflows(toolkitId: string): string[] {
  ...
  return workflowMap[toolkitId] || ["General support workflows"];
}
